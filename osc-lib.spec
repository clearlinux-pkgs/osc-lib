...
%prep
%setup -q -n osc-lib-2.0.0
cd %{_builddir}/osc-lib-2.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583525428
...
cp %{_builddir}/osc-lib-2.0.0/LICENSE %{buildroot}/usr/share/package-licenses/osc-lib/294b43b2cec9919063be1a3b49e8722648424779
