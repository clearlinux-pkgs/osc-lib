...
Version  : 1.3.0
Release  : 7
URL      : https://pypi.debian.net/osc-lib/osc-lib-1.3.0.tar.gz
Source0  : https://pypi.debian.net/osc-lib/osc-lib-1.3.0.tar.gz
...
%prep
%setup -q -n osc-lib-1.3.0

%build
export LANG=C
export SOURCE_DATE_EPOCH=1492439069
