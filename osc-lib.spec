...
Source0  : https://files.pythonhosted.org/packages/2e/9b/91e3af2ecc91ba84ea73d98bc55cb997686609f5bca2e7093b4420fcfad2/osc-lib-2.2.1.tar.gz
...
%prep
%setup -q -n osc-lib-2.2.1
cd %{_builddir}/osc-lib-2.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599602804
...
cp %{_builddir}/osc-lib-2.2.1/LICENSE %{buildroot}/usr/share/package-licenses/osc-lib/294b43b2cec9919063be1a3b49e8722648424779
